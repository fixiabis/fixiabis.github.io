...
THREE.MMDLoader.prototype.loadFileCache = {}; //cache
...
THREE.MMDLoader.prototype.loadFile = function (url, onLoad, onProgress, onError, responseType, mimeType) {
	...
	var request = loader.load(url, function (result) {
		THREE.MMDLoader.prototype.loadFileCache[url] = result; //cache
		onLoad(result);
...
THREE.MMDLoader.prototype.loadFileAsBuffer = function (url, onLoad, onProgress, onError) {
	...
	if (this.__proto__.loadFileCache[url] != undefined) //cache
		onLoad(this.__proto__.loadFileCache[url]); //cache
	else //cache
